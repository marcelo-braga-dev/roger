...
export default function ({id, dados}) {
    ...
    function submit(e) {
        ...
        if (data.senha && data.senha === data.confirmar) {
            router.put(route('admin.usuarios.admins-senhas-update', id), {
                '_method': 'put',
                ...data
            })
            return
    ...
    return (
        <Layout container titlePage="Atualizar Senha" menu="usuarios" voltar={route('admin.usuarios.admins.show', id)}>
            <div className="mb-5">
